...
public class catesubRAdapter extends RecyclerView.Adapter<catesubRAdapter.ViewHolder>{

    private List<data_model> data = new ArrayList<data_model>();

    public catesubRAdapter(List<data_model> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.catesub_horilist, null);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        Picasso.with(viewHolder.image.getContext())
                ...
                .placeholder(data.get(position).getImage())
